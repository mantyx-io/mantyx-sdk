...
description: "Every SSE event and resolved-content blob exchanged between MANTYX and an SDK during an agent run."
---

This is the SDK-builder reference for the **messaging layer** that sits on top
of the HTTP / SSE endpoints documented in
[`agent-runs-protocol.md`](/docs/protocol/). It catalogs every
...
See [`agent-runs-protocol.md` §4.0.1](/docs/protocol/) for the full
...
- [`agent-runs-protocol.md`](/docs/protocol/) — HTTP routes, auth,
